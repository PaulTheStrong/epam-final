...
<body>
    ...
    <div id="main">
        ...
        <form method="post" class="login-form" enctype="multipart/form-data">
            ...
            <div class="mb15">
                <custom:error bundle="${rb}" errorName="${requestScope.titleError}" />
            ...
            <div class="mb15">
                <custom:error bundle="${rb}" errorName="${requestScope.descriptionError}"/>
            ...
            <div class="mb15">
                <custom:error bundle="${rb}" errorName="${requestScope.quantityError}"/>
            ...
            <div class="mb15" id="authors">
                ...
                <custom:error bundle="${rb}" errorName="${requestScope.authorError}"/>
            ...
            <label class="mtb0"><fmt:message key="edit.book.genres" bundle="${rb}" /></label>
                <c:forEach var="genre" items="${book.genres}">
                    <input type="text" name="genre" value="${genre.name}" class="input-field mt5" maxlength="50">
                </c:forEach>
            </div>
        ...
        <custom:error bundle="${rb}" errorName="${requestScope.bookNotFoundError}"/>
    </div>
</body>
